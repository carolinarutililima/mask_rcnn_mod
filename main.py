...
def resnet_graph(input_image, architecture, stage5=False, train_bn=True):
    ...
    x = identity_block(x, 3, [128, 128, 512], stage=3, block='e', train_bn=train_bn)
    x = identity_block(x, 3, [128, 128, 512], stage=3, block='f', train_bn=train_bn)
    x = identity_block(x, 3, [128, 128, 512], stage=3, block='g', train_bn=train_bn)
    C3 = x = identity_block(x, 3, [128, 128, 512], stage=3, block='h', train_bn=train_bn)
    # Stage 4
